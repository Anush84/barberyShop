...
<%@ page import="model.Appointement" %>
...
<%List<Images> allImage = (List<Images>) request.getSession().getAttribute("allImages");%>
<%List<Appointement> allAppointement = (List<Appointement>) request.getAttribute("allAppointment");%>
<!-- header-start -->
<header>
...
<div class="service_area">
    <div class="container">
        ...
        <div class="white_bg_pos">
            <div class="row">
                <div class="col-xl-6">
                    <table border="1px">
                        <%for (Appointement appointement : allAppointement) {%>
                        ...
                        <th>Phone Number:</th>
                        <tr>
                            <td><%=appointement.getName()%>
                            </td>
                            <td><%=appointement.getTime()%>
                            </td>
                            <td><%=appointement.getMaster().getId()%>
                            </td>
                            <td><%=appointement.getService().getId()%>
                            </td>
                            <td><%=appointement.getPhoneNumber()%>
                            </td>
                            <td><%=appointement.getEmail()%>
                            </td>
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="single_service d-flex justify-content-between align-items-center">
                            <div class="service_inner d-flex align-items-center">
                                <div class="thumb">
                                    <img src="/getImage?imgName=<%=service.getImgPath()%>" alt="">
                                </div>
                ...
                <div class="col-xl-12">
                    <div class="gallery_active owl-carousel">
                        ...
                        <div class="single_gallery">
                            <div class="thumb">
                                <img src="/getImage?imgName=<%=images.getImgPath()%>">
                                <div class="image_hover">
                                    <a class="popup-image" href="/getImage?imgName=<%=images.getImgPath()%>">
                                        <i class="ti-plus"></i>
                                    </a>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="single_master">
                        <div class="thumb">
                            <img src="/getImage?imgName=<%=master.getImgPath()%>">
    ...
    <!-- form itself end -->
    <form id="test-form2" class="white-popup-block mfp-hide" action="/addImages" method="post"
          enctype="multipart/form-data">
        <div class="popup_box ">
            <div class="popup_inner">
                <h3>Add Image</h3>
