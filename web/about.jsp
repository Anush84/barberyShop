...
<%List<Images> allImages = (List<Images>) request.getSession().getAttribute("allImages");%>
            ...
            <div class="row">
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="footer_widget">
                        ...
                        <p class="footer_text doanar"><a class="first" href="#">Make Appointement</a> <br>
...
<!-- form itself end-->
<form id="test-form" class="white-popup-block mfp-hide" action="/addAppointement" method="post">
    <div class="popup_box ">
        <div class="popup_inner">
            <h3>Make an Appointement</h3>
            <form action="#">
                <div class="row">
