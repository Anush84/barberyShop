                        ...
                        <div class="main-menu  d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    ...
                                    <li><a class="popup-with-form" href="#test-form2">login </a></li>                                    <li><a href="#">blog <i class="ti-angle-down"></i></a>
                                        <ul class="submenu">
                    ...
                    <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                        <div class="book_room">
                            <div class="book_btn d-none d-lg-block">
                                <a class="popup-with-form" href="#test-form">Make an Appointement</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="book_btn text-center">
                        <a class="boxed-btn3 popup-with-form" href="#test-form">Make an Appointement</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6">
                        ...
                        <select class="form-select wide" id="default-select1" class="" name="service_id">
                            ...
                            <option name="service_id" value="<%=service.getId()%>"><%=service.getName()%></option>
                            <% }%>
                    ...
                    <div class="col-xl-6 col-md-6">
                        <select class="form-select wide" id="default-select" class="" name="master_id">
                            ...
                            <%
                                for (Master master : allMaster) {%>
                            <option value="<%=master.getId()%>" name="master_id"><%=master.getName()%></option>
